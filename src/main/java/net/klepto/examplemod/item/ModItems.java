package net.klepto.examplemod.item;

import net.klepto.examplemod.block.custom.FuelItem;
import net.klepto.examplemod.item.custom.MetalDetectorItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ModConfig.MOD_ID);
